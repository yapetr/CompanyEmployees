...
private Employee createEmployee() throws Exception {
	int salary=view.getIntValue("enter a salary value", company.getMinSalary(),
			company.getMaxSalary());
	String name=view.getStringValue("enter an employee name", 
			company.getNames());
	String position=view.getStringValue("enter position", 
